...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        entry = record_external_stage_artifact(
            ...
            note="The external map was imported by the user; the system does not claim it was generated by 灾情感知及影响评估.",
        )
    ...
    print("灾情感知及影响评估 flexible workflow entry smoke test passed.")
